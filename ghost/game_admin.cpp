...
{
	SendChat( player, "============== Tae Server Welcome ==============" );
	SendChat( player, "contact me >> www.facebook.com/Wuttinunt.ch" );
	SendChat( player, "Example command." );
	SendChat( player, "!pub, !pruve, !map" );
	SendChat( player, "================================================" );
}
